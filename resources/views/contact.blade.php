...
@section('content')
    ...
    <section class="relative w-full h-[350px] lg:h-[400px] flex items-center overflow-hidden">
        ...
        <div class="max-w-[1600px] mx-auto px-4 lg:px-8 w-full relative z-10">
            <div class="lg:w-1/2" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="max-w-[1600px] mx-auto px-4 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div data-aos="fade-right" data-aos-duration="800">
                    <span class="text-xs font-bold text-accent-lightgreen tracking-widest uppercase block mb-2">GET IN TOUCH</span>
                    ...
                    <div class="space-y-5 mb-8">
                        <div class="flex items-start space-x-4" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 leading-relaxed">Citra Indah City – Bukit Anyelir AE12/3,<br>Bogor – West Java 16914, Indonesia</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-3 mt-1">
                                    <a href="#" class="text-gray-600 hover:text-primary transition"><i class="fa-brands fa-linkedin text-lg"></i></a>
                                    <a href="#" class="text-gray-600 hover:text-primary transition"><i class="fa-brands fa-instagram text-lg"></i></a>
                    ...
                    <!-- Tagline Box -->
                    <div class="bg-gray-50 border-l-4 border-accent-lightgreen p-5 rounded-r-lg" data-aos="fade-up" data-aos-delay="700">
                        <div class="flex items-start space-x-3">
                            <i class="fa-solid fa-leaf text-accent-lightgreen text-xl mt-1"></i>
                            <div>
                                <h4 class="text-sm font-bold text-gray-900 mb-1">We Care. We Collaborate. We Create Impact.</h4>
                                <p class="text-xs text-gray-600 leading-relaxed">Your sustainability goals are our priority. Let's turn strategy into measurable action.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- RIGHT: Contact Form -->
                <div class="bg-gray-50 p-8 lg:p-10 rounded-2xl border border-gray-100" data-aos="fade-left" data-aos-duration="800">
                    ...
                    <form action="#" method="POST" class="space-y-4">
                        ...
                        <div class="flex items-start space-x-3 pt-2">
                            ...
                            <label class="text-xs text-gray-600 leading-relaxed">I agree that QRST may collect and use my information to respond to my inquiry.</label>
                        </div>
    ...
    <section class="w-full bg-gray-50 border-t border-gray-200">
        <div class="max-w-[1600px] mx-auto px-4 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3">
                <!-- Left: Info -->
                <div class="bg-primary-dark p-10 lg:p-12 text-white flex flex-col justify-center" data-aos="fade-right" data-aos-duration="800">
                ...
                <!-- Right: Map Embed -->
                <div class="lg:col-span-2 h-80 lg:h-auto min-h-[400px]" data-aos="fade-left" data-aos-duration="800">
                    <iframe
        ...
        <div class="max-w-[1600px] mx-auto px-4 lg:px-8">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div class="text-center" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <p class="text-xs text-gray-600 leading-relaxed">Experienced and dedicated professionals ready to support your goals.</p>
                </div>
                <!-- Stat 2 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <p class="text-xs text-gray-600 leading-relaxed">Delivering solutions with measurable impact across various industries.</p>
                </div>
                <!-- Stat 3 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <p class="text-xs text-gray-600 leading-relaxed">End-to-end services tailored to your sustainability needs.</p>
                </div>
                <!-- Stat 4 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <p class="text-xs text-gray-600 leading-relaxed">Building long-term partnerships based on trust and collaboration.</p>
                </div>
                <!-- Stat 5 -->
                <div class="text-center" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <p class="text-xs text-gray-600 leading-relaxed">Committed to creating positive impact for people, business, and the planet.</p>
                </div>
            </div>
        </div>
    </section>
